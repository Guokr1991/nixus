...
;; using SSE instructions. The code was extracted from
;; the  book "Introduction to 64 Bit Intel Assembly Language
;; Programming for Linux: Second Edition", by Ray Seyfarth,
;; chapter 19 (Kindle edition).
...
.more:
        ...
        sub     rcx, 4
        jnz     .more
	;; Compute cross correlation using SSE instructions
        addpd   xmm0, xmm8
        addpd   xmm1, xmm9
        addpd   xmm2, xmm10
        addpd   xmm3, xmm11
